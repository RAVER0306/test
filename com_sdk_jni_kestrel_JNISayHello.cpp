...
#include <iostream>
#include "<com_sdk_jni_kestrel_KestrelStructHh>"
...
JNIEXPORT jint JNICALL Java_com_sdk_jni_kestrel_KestrelStructHh_kestrel_1plugin_1load(JNIEnv *env, jobject, jstring pluginNameString, jstring suffix)
{
...
JNIEXPORT jint JNICALL Java_com_sdk_jni_kestrel_KestrelStructHh_kestrel_1annotator_1open(JNIEnv *env, jobject, jstring pluginNameString, jstring modelJsonString)
{
